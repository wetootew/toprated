...
{ 
    ...
    public function __construct($dbname = null, $host = null, $usr = null, $pw = null, $permcon = false, $charset = "utf8") { 
        ...
        if ($permcon)  
            $this->mysql_link = @mysqli_pconnect('p:' . $host, $usr, $pw); 
        else
            $this->mysql_link = @mysqli_connect ($host, $usr, $pw); 
    ...
    public function ErrorNumber() { 
        if (strlen($this->error_desc) > 0 && $this->error_number == 0) 
            return -1; 
    ...
    */ 
    ...
    public function IsConnected() { 
        return is_object($this->mysql_link);
    } 
